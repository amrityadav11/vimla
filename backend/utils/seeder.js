...
const defaultSettings = [
    ...
    { key: 'whatsapp', value: '919876543210', group: 'contact', label: 'WhatsApp Number' },
    { key: 'email', value: 'info@vimlajanch.com', group: 'contact', label: 'Email' },
    { key: 'address', value: 'Near Main Market, Your City, State — 000000', group: 'contact', label: 'Address' },
    { key: 'city', value: 'Your City', group: 'contact', label: 'City' },
    { key: 'openingHours', value: 'Mon–Sat: 7:00 AM – 8:00 PM | Sun: 8:00 AM – 2:00 PM', group: 'contact', label: 'Opening Hours' },
    { key: 'googleMapsUrl', value: 'https://maps.google.com/?q=Vimla+Janch+Ghar', group: 'contact', label: 'Google Maps URL' },
    ...
    { key: 'metaDescription', value: 'विमला जाँच घर (Vimla Janch Ghar) provides reliable pathology and diagnostic laboratory testing services including blood tests, CBC, thyroid, liver, kidney, lipid profile, urine tests and more.', group: 'seo', label: 'Meta Description' },
];
